<?php
/*
Template Name: Our Voice Warras
*/
    global $wpdb; 
    get_header(); 
?>
...
<div class="video-container-all">
    ...
    <div id = "containter-all">
        ...
        <div id="dj-name">
                ...
                ?>-->
                <iframe width="640" height="360" frameBorder="0" src="http://www.youtube.com/embed/1VJ-GqXfZ_w?autoplay=0&controls=2&showinfo=0&theme=dark"></iframe>
            ...
            <div id="dj-question">
                <!--<?php
                    ...
                    //echo $rst_descr;
                ?>-->
                Do you think the youth of South Africa are powerful enough to institute change?
            </div>
