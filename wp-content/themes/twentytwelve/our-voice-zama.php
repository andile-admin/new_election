...
<div class="video-container-all">
    ...
    <div id = "containter-all">
        ...
        <div id="dj-name">
                ...
                ?>-->
                <iframe width="640" height="360" frameBorder="0" src="http://www.youtube.com/embed/mW5k7DS5Pfk?autoplay=0&controls=2&showinfo=0&theme=dark"></iframe>
            ...
            <div id="dj-question">
                <!--<?php
                    ...
                    //echo $rst_descr;
                ?>-->
                What ideals do you think the current generation should strive for?
            </div>
