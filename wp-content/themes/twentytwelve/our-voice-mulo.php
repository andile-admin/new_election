...
<div class="video-container-all">
    ...
    <div id = "containter-all">
        ...
        <div id="dj-name">
                ...
                ?>-->
                <iframe width="640" height="360" frameBorder="0" src="http://www.youtube.com/embed/BzaxCwrXPFM?autoplay=0&controls=2&showinfo=0&theme=dark"></iframe>
            ...
            <div id="dj-question">
                <!--<?php
                    ...
                    //echo $rst_descr;
                ?>-->
                What changes would you like to see in South Africa in spheres such as government, education and civil society?
            </div>
            ...
            <!--<?php //$loop = new WP_Query( array( 'post_type' => 'the_youtube_post', 'posts_per_page' => 6 ) ); $i=0; ?>
                <?php //while ( $loop->have_posts() ) : $loop->the_post(); ?>-->
                    <div class="each_video-list"> 
                        ...
                        <a href="<?php bloginfo('url'); ?>/zama"><img src="<?php bloginfo('url');?>/wp-content/themes/twentytwelve/images/zama-dube.png"/></a>
                    </div>
                    <!--<div class="thumb-text"><?php //echo get_post_meta($post->ID, 'custom_text_video_name', true); ?></div>-->

                    <div class="thumb-text">Zama Dube</div>

                    <div class="each_video-list"> 
                    
                        <a href="<?php bloginfo('url'); ?>/warras"><img src="<?php bloginfo('url');?>/wp-content/uploads/2013/12/video-image_03.png"/></a>
                    
                    </div>

                    <div class="thumb-text">Warras</div>

                    <div class="each_video-list"> 
                    
                        <a href="<?php bloginfo('url'); ?>/ankletap"><img src="<?php bloginfo('url');?>/wp-content/themes/twentytwelve/images/ankletap_03.png"/></a>
                    
                    </div>

                    <div class="thumb-text">Ankletap</div>

                    <div class="each_video-list"> 
                    
                        <a href="<?php bloginfo('url'); ?>/mulo"><img src="<?php bloginfo('url');?>/wp-content/themes/twentytwelve/images/mulo.png"/></a>
                    
                    </div>

                    <div class="thumb-text">Mulo</div>
