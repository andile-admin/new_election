<?php
/*
Template Name: Our Voice Ankletap
*/
    global $wpdb; 
    get_header(); 
?>
...
<div class="video-container-all">
    ...
    <div id = "containter-all">
        ...
        <div id="dj-name">
                ...
                ?>-->
                <iframe width="640" height="360" frameBorder="0" src="http://www.youtube.com/embed/RhLQQ2W2_Ng?autoplay=0&controls=2&showinfo=0&theme=dark"></iframe>
            ...
            <div id="dj-question">
                <!--<?php
                    ...
                    //echo $rst_descr;
                ?>-->
                Do you think that youth participation in voting and the 2014 elections will cause change in SA?
            </div>
