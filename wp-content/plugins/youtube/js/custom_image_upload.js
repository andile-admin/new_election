    ...
    $( function() {
        $.fn.wptuts = function( options ) {
            ...
            $( options.button ).click( function() {
                $('#TB_title:nth-of-type(2)').hide();
                // Get the Text element.
                var text = $( this ).siblings( options.text );
 
                // Show WP Media Uploader popup
                tb_show( 'Upload Movie Poster', 'media-upload.php?referer=wptuts&type=image&TB_iframe=true&post_id=0', false );
